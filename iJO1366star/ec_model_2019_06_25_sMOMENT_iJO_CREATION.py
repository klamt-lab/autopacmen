...
json_output_folder = "./iJO1366star/ec_model_2019_06_25_output/"
parse_bigg_metabolites_file(bigg_metabolites_file_path, json_output_folder)

# Step 2
brenda_textfile_path = "./iJO1366star/ec_model_2019_06_25_input/brenda_download.txt"
bigg_metabolites_json_folder = "./iJO1366star/ec_model_2019_06_25_output/"
json_output_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_brenda.json"
parse_brenda_textfile(brenda_textfile_path,
                      bigg_metabolites_json_folder, json_output_path)

# Step 3
sbml_path = "./iJO1366star/ec_model_2019_06_25_input/iJO1366.xml"
brenda_json_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_brenda.json"
output_json_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_brenda_for_model.json"
parse_brenda_json_for_model(sbml_path, brenda_json_path, output_json_path)

# Step 4
sbml_path = "./iJO1366star/ec_model_2019_06_25_input/iJO1366.xml"
json_output_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_sabio_rk.json"
bigg_id_name_mapping_path: str = "./iJO1366star/ec_model_2019_06_25_output/bigg_id_name_mapping.json"
parse_sabio_rk_for_model_with_sbml(
    sbml_path, json_output_path, bigg_id_name_mapping_path)

# Step 5
sabio_rk_kcat_database_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_sabio_rk.json"
brenda_kcat_database_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_brenda_for_model.json"
output_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_combined.json"
create_combined_kcat_database(
    sabio_rk_kcat_database_path, brenda_kcat_database_path, output_path)

# Step 6
sbml_path = "./iJO1366star/ec_model_2019_06_25_input/iJO1366.xml"
project_folder = "./iJO1366star/ec_model_2019_06_25_output/"
project_name = "psb_orth"
organism = "Escherichia coli"
kcat_database_path = "./iJO1366star/ec_model_2019_06_25_output/kcat_database_combined.json"
protein_kcat_database_path = "./iJO1366star/ec_model_2019_06_25_input_keff_paper/gene_id_data_mapping.json"
get_reactions_kcat_mapping(sbml_path, project_folder, project_name,
                           organism, kcat_database_path, protein_kcat_database_path)

# Step 7
input_sbml = "./iJO1366star/ec_model_2019_06_25_input/iJO1366.xml"
project_folder = "./iJO1366star/ec_model_2019_06_25_output/"
project_name = "psb_orth"
...
# Step 9
input_sbml = "./iJO1366star/ec_model_2019_06_25_input/iJO1366.xml"
output_sbml = "iJO1366_sMOMENT_2019_06_25.xml"
project_folder = "./iJO1366star/ec_model_2019_06_25_output/"
project_name = "psb_orth"
...
model = set_up_ec_model_with_sbml(
    "./iJO1366star/ec_model_2019_06_25_output/iJO1366_sMOMENT_2019_06_25.xml", .25)
cobra.io.write_sbml_model(
    model, "./iJO1366star/ec_model_2019_06_25_output/iJO1366_sMOMENT_2019_06_25_STANDARD_EXCHANGE_SCENARIO.xml")
