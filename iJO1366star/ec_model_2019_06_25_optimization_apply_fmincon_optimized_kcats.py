...
for reaction_to_change in reactions_to_change[: len(new_kcats_fmincon)]:
    ...
    reaction.add_metabolites({prot_pool_metabolite: -old_stoichiometry})
    reaction.add_metabolites({prot_pool_metabolite: new_kcats_fmincon[i]})

    i += 1

# cobra.io.write_sbml_model(model, "./iJO1366star/ec_model_2019_06_25_output_optimization/iJO1366_sMOMENT_2019_06_25_STANDARD_EXCHANGE_SCENARIO_MANUAL_CHANGES_FMINCON_CHANGE_FACTOR_50.xml")
cobra.io.write_sbml_model(
    model, "./iJO1366star/ec_model_2019_06_25_output_optimization/iJO1366star.xml"
)
