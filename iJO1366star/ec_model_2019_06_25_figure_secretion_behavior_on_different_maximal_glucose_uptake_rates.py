...
def fba_with_glucose_levels(model, glucose_levels, name):
    ...
    for glucose_level in glucose_levels:
        ...
        with model:
            ...
            print(
                ...
                == model.reactions.ER_pool_TG_.upper_bound,
            )
            print(
                "Max glucose?:",
            ...
            fva_solution = cobra.flux_analysis.flux_variability_analysis(
                model,
                reaction_list=fva_reactions,
                loopless=False,
                fraction_of_optimum=1.0,
            )
            values["growth"].append(
                (
                    fva_solution.loc["BIOMASS_Ec_iJO1366_core_53p95M", "minimum"]
                    + fva_solution.loc["BIOMASS_Ec_iJO1366_core_53p95M", "maximum"]
                )
                / 2
            )
            values["growth_var"].append(
                abs(
                    fva_solution.loc["BIOMASS_Ec_iJO1366_core_53p95M", "maximum"]
                    - fva_solution.loc["BIOMASS_Ec_iJO1366_core_53p95M", "minimum"]
                )
            ...
            values["prot_pool"].append(
                (
                    fva_solution.loc["ER_pool_TG_", "minimum"]
                    + fva_solution.loc["ER_pool_TG_", "maximum"]
                )
                / 2
            )
            values["prot_pool_var"].append(
                abs(
                    fva_solution.loc["ER_pool_TG_", "maximum"]
                    - fva_solution.loc["ER_pool_TG_", "minimum"]
                )
            ...
            values["glucose"].append(
                (
                    fva_solution.loc["EX_glc__D_e", "minimum"]
                    + fva_solution.loc["EX_glc__D_e", "maximum"]
                )
                / 2
            )
            values["glucose_var"].append(
                abs(
                    fva_solution.loc["EX_glc__D_e", "maximum"]
                    - fva_solution.loc["EX_glc__D_e", "minimum"]
                )
            ...
            values["ethanol"].append(
                (
                    fva_solution.loc["EX_etoh_e", "minimum"]
                    + fva_solution.loc["EX_etoh_e", "maximum"]
                )
                / 2
            )
            values["ethanol_var"].append(
                abs(
                    fva_solution.loc["EX_etoh_e", "maximum"]
                    - fva_solution.loc["EX_etoh_e", "minimum"]
                )
            ...
            values["formate"].append(
                (
                    fva_solution.loc["EX_for_e", "minimum"]
                    + fva_solution.loc["EX_for_e", "maximum"]
                )
                / 2
            )
            values["formate_var"].append(
                abs(
                    fva_solution.loc["EX_for_e", "maximum"]
                    - fva_solution.loc["EX_for_e", "minimum"]
                )
            ...
            values["acetate"].append(
                (
                    fva_solution.loc["EX_ac_e", "minimum"]
                    + fva_solution.loc["EX_ac_e", "maximum"]
                )
                / 2
            )
            values["acetate_var"].append(
                abs(
                    fva_solution.loc["EX_ac_e", "maximum"]
                    - fva_solution.loc["EX_ac_e", "minimum"]
                )
            ...
            values["lactate"].append(
                (
                    fva_solution.loc["EX_lac__D_e", "minimum"]
                    + fva_solution.loc["EX_lac__D_e", "maximum"]
                )
                / 2
            )
            values["lactate_var"].append(
                abs(
                    fva_solution.loc["EX_lac__D_e", "maximum"]
                    - fva_solution.loc["EX_lac__D_e", "minimum"]
                )
            ...
            values["succinate"].append(
                (
                    fva_solution.loc["EX_succ_e", "minimum"]
                    + fva_solution.loc["EX_succ_e", "maximum"]
                )
                / 2
            )
            values["succinate_var"].append(
                abs(
                    fva_solution.loc["EX_succ_e", "maximum"]
                    - fva_solution.loc["EX_succ_e", "minimum"]
                )
            ...
            values["co2"].append(
                (
                    fva_solution.loc["EX_co2_e", "minimum"]
                    + fva_solution.loc["EX_co2_e", "maximum"]
                )
                / 2
            )
            values["co2_var"].append(
                abs(
                    fva_solution.loc["EX_co2_e", "maximum"]
                    - fva_solution.loc["EX_co2_e", "minimum"]
                )
            ...
            values["o2_var"].append(
                abs(
                    fva_solution.loc["EX_o2_e", "maximum"]
                    - fva_solution.loc["EX_o2_e", "minimum"]
                )
            )
    ...
    print(
        "Actual glucose uptake" + ";" + ";".join([str(-x) for x in values["glucose"]])
    )
    ...
    print(
        ...
        + ";"
        + ";".join([str(x) for x in values["glucose_var"]])
    )
    print(
        "Variability of acetate"
        + ";"
        + ";".join([str(x) for x in values["acetate_var"]])
    )
    print(
        "Variability of ethanol"
        + ";"
        + ";".join([str(x) for x in values["ethanol_var"]])
    )
    print(
        "Variability of formate"
        + ";"
        + ";".join([str(x) for x in values["formate_var"]])
    )
    print(
        "Variability of lactate"
        + ";"
        + ";".join([str(x) for x in values["lactate_var"]])
    )
    print(
        "Variability of succinate"
        + ";"
...
aerobic_space = list(np.linspace(0.14, 9.53, 25)) + list(np.linspace(9.54, 13.829, 25))
