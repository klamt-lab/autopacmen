...
"""./iJO1366star/ec_model_2019_06_25_test_fva_variability_data.py
...
model_original = cobra.io.read_sbml_model(
    "./iJO1366star/ec_model_2019_06_25_input/iJO1366_saved_by_cobrapy_and_separated_reversible_reactions_STANDARD_EXCHANGE_SCENARIO.xml"
)

model_smoment.reactions.get_by_id("EX_glc__D_e").lower_bound = -9.53
model_smoment.reactions.get_by_id("ER_pool_TG_").upper_bound = 0.095
with model_smoment:
...
n, bins, patches = ax.hist(
    variabilites_original,
    n_bins,
    density=True,
    histtype="step",
    cumulative=True,
    label=f"iJO1366 (n={len(variabilites_original)})",
)

# Overlay a reversed cumulative histogram.
ax.hist(
    variabilities_smoment,
    bins=bins,
    density=True,
    histtype="step",
    cumulative=True,
...
plt.show()
fig.savefig(
    "./iJO1366star/ec_model_2019_06_25_test_fva/fva_comparison_2019_06_25_fitted_mc_fm_50_vs_original_iJO1366_both_with_standard_exchange_scenario.png"
)
...
workbook = xlsxwriter.Workbook(
    f"./iJO1366star/ec_model_2019_06_25_test_fva/fva_comparison_2019_06_25_fitted_mc_fm_50_vs_original_iJO1366_both_with_standard_exchange_scenario.xlsx"
)
